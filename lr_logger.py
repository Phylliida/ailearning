# from https://github.com/PyTorchLightning/PyTorch-Lightning/blob/0.9.0/pytorch_lightning/callbacks/lr_logger.py#L31-L156
    ...
    def on_batch_start(self, trainer, pl_module):
        if self.logging_interval != 'epoch':
            ...
            if trainer.logger is not None and latest_stat:
                if trainer.global_step % 10 == 0: print(latest_stat, trainer.global_step)
